...
#SBATCH -p g48
#SBATCH --job-name=REPE_harmfulness_experiment
...
# =============================================================================
# REPE Harmfulness vs Helpfulness Experiment Runner
# =============================================================================
# This script runs experiments to analyze the trade-off between harmfulness
# and helpfulness in language models using Representation Engineering (REPE).
# It evaluates models on MMLU datasets with various coefficient values.
# =============================================================================
...
# Available MMLU dataset categories for testing
...
OUTPUT_DIR="/path/to/experiment/outputs/harmfulness_experiments/${current_time}"
...
# Optional: Enable synthetic reading vectors
...
CMD="python experiments/harmfulness_experiments/harmfulness_helpfulness_new.py \
    $MODEL_NAME \
    $DATASET_PATH \
    $DATASET_NAMES \
    $START_COEFF \
...
echo "Starting harmfulness vs helpfulness experiment..."
