...
# choices = ['high_school_computer_science', 'medical_genetics', 'international_law']
# DATASET_MMLU_NAMES_ARG="--dataset_mmlu_names high_school_computer_science,medical_genetics,international_law,"
