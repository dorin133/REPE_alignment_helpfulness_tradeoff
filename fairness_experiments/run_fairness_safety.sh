...
OUTPUT_DIR="/home/dshteyma/REPE_alignment_helpfulness_tradeoff/data/fairness_experiments_outputs/safety_${current_time}"
...
CMD="python experiments/fairness_experiments/fairness_safety_new.py \
                                                    $MODEL_NAME \
                                                    $DATASET_PATH \
                                                    $DATASET_NAMES \
                                                    $START_COEFF \
