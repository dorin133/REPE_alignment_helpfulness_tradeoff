...
def model_name_verify(value: str):
    ...
    choices=['meta-llama/Meta-Llama-3.1-8B-Instruct', 'meta-llama/Meta-Llama-3.1-8B', 'meta-llama/Llama-2-13b-hf', 'meta-llama/Llama-2-13b-chat-hf']
...
class GenerationArgsHelpfulness:
    def __init__(self):
        ...
        parser.add_argument('--start_coeff', default=0.0, type=float, help='coeff to start the range of the norm injection of the representation vector')
        parser.add_argument('--end_coeff', default=1.5, type=float, help='coeff to end the range of the norm injection of the representation vector')
        parser.add_argument('--coeff_step', default=0.1, type=float, help='step for the range of the norm injection of the representation vector')
